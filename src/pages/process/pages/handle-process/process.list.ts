...
export const ProcessList: Omit<ProcessItem, "date" | "status" | "itemStyle">[] = [
  ...
  },
  {
    index: 2,
    title: "个人申请阶段",
    step: "individual_application_stage",
  ...
  },
  {
    index: 6,
    title: "第二次个人自评",
    step: "second_personal_self_assessment",
  ...
  },
  {
    index: 7,
    title: "第二次班级公示",
    step: "second_class_announcement",
  ...
  },
  {
    index: 9,
    title: "学科办审核、复查",
    step: "examination_and_review_of_the_discipline_office",
  ...
  },
  {
    index: 10,
    title: "奖学金评定小组核查、审议",
    step: "verification_and_deliberation_by_the_scholarship_evaluation_group",
...
export const getProcessList = (statusInfo?: IStatusInfo): ProcessItem[] => {
  ...
  return ProcessList.map(item => {
    const info = statusInfo ? (statusInfo[item.step as ProcessStep] || defaultInfo) : defaultInfo;
